...
//  CloudCast
//
//  Created by lizgarciao on 3/14/24.
//
...
class WeatherForecastService {
    static func fetchForecast(latitude: Double,
        ...
        let task = URLSession.shared.dataTask(with: url) { data, response, error in
            ...
            // note: guard enforces early exit if condition fails.
            ...
            let decoder = JSONDecoder() // decpdes data according to the WeaterAPIResponse defined by us
            ...
            DispatchQueue.main.async {
                completion?(response.currentWeather) // call the completion closure and pass in the forecast data model
            }
        }
